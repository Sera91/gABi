...
from coreBN.models import MarkovChain, MarkovNetwork
from coreBN.sampling import BayesianModelInference, _return_samples
from coreBN.utils.mathext import sample_discrete, sample_discrete_maps
...
class BayesianModelSampling(BayesianModelInference):
    ...
    def rejection_sample(
        ...
        Parameters
        ----------
        evidence: list of `core.factor.State` namedtuples
            None if no evidence
...
class GibbsSampling(MarkovChain):
    ...
    >>> from coreBN.sampling import GibbsSampling
