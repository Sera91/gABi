...
class DAG(nx.DiGraph):
    ...
    **Shortcuts:**
    ...
    def to_pdag(self):
        ...
        Returns
        -------
        Partially oriented DAG: coreBN.base.PDAG
            An instance of coreBN.base.PDAG.
        Examples
        --------
        """
        pass
    ...
    def get_ancestral_graph(self, nodes):
        ...
        Returns
        -------
        Ancestral Graph: coreBN.base.DAG
        Examples
        --------
        >>> from coreBN.base import DAG
