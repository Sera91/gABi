...
class TestMarkovChain(unittest.TestCase):
    ...
    @patch("coreBN.models.MarkovChain._check_state", autospec=True)
    ...
    @patch.object(sys.modules["coreBN.models.MarkovChain"], "warn")
    def test_add_variable_existing(self, warn):
        model = MC(["p"], [2])
        model.add_variable("p", 3)
        self.assertEqual(warn.call_count, 1)

    @patch("coreBN.models.MarkovChain.add_variable", autospec=True)
    ...
    @patch("coreBN.models.MarkovChain.random_state", autospec=True)
    ...
    @patch("coreBN.models.MarkovChain.sample", autospec=True)
    ...
    @patch.object(sys.modules["coreBN.models.MarkovChain"], "sample_discrete")
