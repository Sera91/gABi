...
class RCIT:
    def __init__(self, x=None, y=None, z=None, num_f=25, num_f2=5, approx=None):
        self.x = x
        self.y = y
        self.z = z
	self.num_f = num_f
    ...
    def rcit(self, x, y, z=None, num_f=25, num_f2=5, seed=None,r=500):
        """
        ...
        (four_y, w, b) = self.random_fourier_features(
            new_y, num_f=num_f2, sigma=np.median(self.dist(y[:r1, ])), seed=seed)
        f_x = self.normalizeMat(four_x)
