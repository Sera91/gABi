...
class BIFReader(object):
    ...
    def __init__(self, path=None, string=None, include_properties=False, n_jobs=-1):
        ...
        <coreBN.IO.BIF.BIFReader object at 0x7f2375621cf8>
    ...
    def get_values(self):
        ...
        Example
        --------
        >>> from coreBN.readwrite import BIFReader
        >>> reader = BIFReader("bif_test.bif")
        >>> reader.get_values()
    ...
    def get_model(self, state_name_type=str):
        ...
        >>> reader = BIFReader("bif_test.bif")
        >>> reader.get_model()
        <core.models.BayesianNetwork.BayesianNetwork object at 0x7f20af154320>
        """
        try:
...
$values
    ...
    def get_variables(self):
        ...
        Example
        -------
        >>> from coreBN.IO import BIFReader, BIFWriter
    ...
    def get_properties(self):
        ...
        Example
        -------
        >>> from coreBN.readwrite import BIFReader, BIFWriter
        >>> model = BIFReader('dog-problem.bif').get_model()
        >>> writer = BIFWriter(model)
