...
from coreBN.models import SEMGraph, SEMAlg, SEM
from coreBN.global_vars import device, dtype
from coreBN.utils import optimize, pinverse
...
class SEMEstimator(object):
    ...
    def get_init_values(self, data, method):
        ...
        Reference
        ---------
        Bollen, K. (2014). Structural Equations with Latent Variables.
    ...
    def fit(
        ...
        **kwargs,
        ...
        Parameters
        ----------
        data: pandas DataFrame or coreBN.data.Data instance
        ...
        **kwargs: dict
        ...
        Returns
        -------
            coreBN.model.SEM instance: Instance of the model with estimated parameters
...
class IVEstimator:
    ...
    def fit(self, X, Y, data, ivs=None, civs=None):
        ...
        Examples
        --------
        >>> from coreBN.estimators import IVEstimator # TODO: Finish example.
        """
