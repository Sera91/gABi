...
class TreeSearch(StructureEstimator):
    ...
    def estimate(
        ...
        >>> from coreBN.estimators import TreeSearch
    ...
    def _get_weights(
        ...
        coreBN.estimators.TreeSearch for more details. This function returns the edge weights matrix.
    ...
    def _get_conditional_weights(
        ...
        coreBN.estimators.TreeSearch for more details. This function returns the
        edge weights matrix.
    ...
    def _create_tree_and_dag(weights, columns, root_node):
        """
        Helper function to Chow-Liu algorithm for estimating tree structure from given data. Refer to
        coreBN.estimators.TreeSearch for more details. This function returns the DAG based on the edge weights matrix.
