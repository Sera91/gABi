...
from coreBN.global_vars import HAS_PANDAS
...
class SEMGraph(DAG):
    ...
    def __init__(self, ebunch=[], latents=[], err_corr=[], err_var={}):
        ...
        >>> from coreBN.models import SEMGraph
    ...
    def to_lisrel(self):
        ...
        representation which is implemented by `core.models.SEMAlg` class.
        ...
        from coreBN.models import SEMAlg
    ...
    def to_standard_lisrel(self):
        ...
        See Also
        --------
        to_lisrel: Converts the model to `core.models.SEMAlg` instance.
...
class SEMAlg:
    ...
    def __init__(self, eta=None, B=None, zeta=None, wedge_y=None, fixed_values=None):
        ...
        Returns
        -------
        coreBN.models.SEMAlg instance: An instance of the object with initalized values.
    ...
    def to_SEMGraph(self):
        ...
        Returns
        -------
        coreBN.models.SEMGraph instance: A path model of the model.
...
class SEM(SEMGraph):
    ...
    def from_lisrel(cls, var_names, params, fixed_masks=None):
        ...
        Returns
        -------
        coreBN.models.SEM instance: An instance of the object with initalized values.
    ...
    def from_RAM(
        ...
        Returns
        -------
        coreBN.models.SEM instance: An instance of the object with initialized values.
