...
from coreBN.estimators import StructureEstimator, ScoreCache
from coreBN.estimators import K2Score
...
class ExhaustiveSearch(StructureEstimator):
    ...
    def all_dags(self, nodes=None):
        ...
        --------
        >>> import pandas as pd
        >>> from coreBN.estimators import ExhaustiveSearch
    ...
    def all_scores(self):
        ...
        >>> import pandas as pd
        >>> import numpy as np
        >>> from coreBN.estimators import ExhaustiveSearch, K2Score
    ...
    def estimate(self):
        ...
        >>> best_model
        <coreBN.base.DAG.DAG object at 0x7f695c535470>
        >>> best_model.edges()
        [('B', 'C')]
        """
