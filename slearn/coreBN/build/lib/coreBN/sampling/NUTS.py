...
from coreBN.sampling import HamiltonianMCDA, LeapFrog, _return_samples
...
class NoUTurnSampler(HamiltonianMCDA):
    ...
    Example
    -------
    >>> from coreBN.sampling import NoUTurnSampler as NUTS, LeapFrog, GradLogPDFGaussian
    ...
    def sample(self, initial_pos, num_samples, stepsize=None, return_type="dataframe"):
        ...
        Examples
        ---------
        >>> from coreBN.sampling import NoUTurnSampler as NUTS, GradLogPDFGaussian, LeapFrog
        >>> from coreBN.factors.continuous import GaussianDistribution as JGD
        >>> import numpy as np
        >>> mean = np.array([0, 0, 0])
    ...
    def generate_sample(self, initial_pos, num_samples, stepsize=None):
        ...
        Examples
        ---------
        >>> from coreBN.sampling import NoUTurnSampler as NUTS, GradLogPDFGaussian
        >>> from coreBN.factors.continuous import GaussianDistribution as JGD
        >>> import numpy as np
        >>> mean = np.array([11, -6])
...
class NoUTurnSamplerDA(NoUTurnSampler):
    ...
    Example
    -------
    >>> from coreBN.sampling import NoUTurnSamplerDA as NUTSda, GradLogPDFGaussian
    >>> from coreBN.factors.continuous import GaussianDistribution as JGD
    >>> import numpy as np
    ...
    def sample(
        ...
        Examples
        ---------
        >>> from coreBN.sampling import NoUTurnSamplerDA as NUTSda, GradLogPDFGaussian, LeapFrog
        >>> from coreBN.factors.continuous import GaussianDistribution as JGD
        >>> import numpy as np
        >>> mean = np.array([10, -13])
