...
class FactorSet(object):
    ...
    def __init__(self, *factors_list):
        ...
        >>> factor_set
        <core.factors.FactorSet.FactorSet at 0x7f8e32af6d50>
        >>> print(factor_set)
    ...
    def copy(self):
        ...
        >>> factor_set = FactorSet(phi1, phi2)
        >>> factor_set
        <core.factors.FactorSet.FactorSet at 0x7fa68f390320>
        >>> factor_set_copy = factor_set.copy()
        >>> factor_set_copy
        <core.factors.FactorSet.FactorSet at 0x7f91a0031160>
        """
...
def factorset_product(*factorsets_list):
    ...
    >>> from coreBN.factors import FactorSet
    >>> from coreBN.factors.discrete import DiscreteFactor
    >>> from coreBN.factors import factorset_product
    >>> phi1 = DiscreteFactor(['x1', 'x2', 'x3'], [2, 3, 2], range(12))
    >>> phi2 = DiscreteFactor(['x3', 'x4', 'x1'], [2, 2, 2], range(8))
    >>> factor_set1 = FactorSet(phi1, phi2)
    >>> phi3 = DiscreteFactor(['x5', 'x6', 'x7'], [2, 2, 2], range(8))
...
def factorset_divide(factorset1, factorset2):
    ...
    >>> from coreBN.factors import FactorSet
    >>> from coreBN.factors.discrete import DiscreteFactor
    >>> from coreBN.factors import factorset_divide
    >>> phi1 = DiscreteFactor(['x1', 'x2', 'x3'], [2, 3, 2], range(12))
    >>> phi2 = DiscreteFactor(['x3', 'x4', 'x1'], [2, 2, 2], range(8))
    >>> factor_set1 = FactorSet(phi1, phi2)
    >>> phi3 = DiscreteFactor(['x5', 'x6', 'x7'], [2, 2, 2], range(8))
