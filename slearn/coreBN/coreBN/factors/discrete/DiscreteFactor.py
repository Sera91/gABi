...
from coreBN.extern import tabulate
from coreBN.factors.base import BaseFactor
from coreBN.utils import StateNameMixin
...
class DiscreteFactor(BaseFactor, StateNameMixin):
    ...
    def identity_factor(self):
        ...
        Returns
        -------
        Identity factor: coreBN.factors.discrete.DiscreteFactor.
    ...
    def marginalize(self, variables, inplace=True):
        ...
        Returns
        -------
        Marginalized factor: coreBN.factors.discrete.DiscreteFactor or None
    ...
    def maximize(self, variables, inplace=True):
        ...
        Returns
        -------
        Maximized factor: coreBN.factors.discrete.DiscreteFactor or None
    ...
    def normalize(self, inplace=True):
        ...
        Returns
        -------
        Normalized factor: coreBN.factors.discrete.DiscreteFactor or None
            If inplace=True (default) returns None else returns a new `DiscreteFactor` instance.
    ...
    def reduce(self, values, inplace=True, show_warnings=True):
        ...
        Returns
        -------
        Reduced factor: coreBN.factors.discrete.DiscreteFactor or None
            If inplace=True (default) returns None else returns a new `DiscreteFactor` instance.
    ...
    def sum(self, phi1, inplace=True):
        ...
        Returns
        -------
        Summed factor: coreBN.factors.discrete.DiscreteFactor or None
            If inplace=True (default) returns None else returns a new `DiscreteFactor` instance.
    ...
    def copy(self):
        ...
        Returns
        -------
        Copy of self: coreBN.factors.discrete.DiscreteFactor
